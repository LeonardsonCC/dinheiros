...
import { Card, CardContent, CardHeader, CardTitle, Input, Label, MultiSelect, ToggleGroup, ToggleGroupItem } from '@/components/ui';
          ...
          {showFilters && (
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Type filter */}
                <div>
                  <Label>{t('allTransactions.type')}</Label>
                  <ToggleGroup
                    variant="default"
                    type="multiple"
                    value={filters.types}
                  ...
                  >
                    <ToggleGroupItem value="income" variant="outline">
                      <PlusCircleIcon className="text-green-500 h-5 w-5 mr-1" /> {t('allTransactions.income')}
                    </ToggleGroupItem>
                    <ToggleGroupItem value="expense" variant="outline">
                      <MinusCircleIcon color="red" className="text-red-500 h-5 w-5 mr-1" /> {t('allTransactions.expense')}
                    </ToggleGroupItem>
                  </ToggleGroup>
                </div>
                ...
                {/* Account filter */}
                <div>
                  <Label>{t('allTransactions.accounts')}</Label>
                  {!initialDataLoaded ? (
                ...
                {/* Category filter */}
                <div>
                  <Label>{t('allTransactions.categories')}</Label>
                  {!initialDataLoaded ? (
                    <div className="flex h-10 w-full items-center justify-center rounded-md border border-input bg-background px-3 py-2 text-sm text-muted-foreground">
                      Loading categories...
                    </div>
