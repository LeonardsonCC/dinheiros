...
const NewAccount = () => {
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold text-slate-900 dark:text-white">New Account</h1>
      <div className="bg-white dark:bg-slate-800 shadow-lg rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-slate-900 dark:text-white">New Account</h3>
