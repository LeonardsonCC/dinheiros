...
func TestNubankExtratoExtractor_ExtractTransactions(t *testing.T) {
	...
	fullTransactions := []models.Transaction{
		...
		},
		{
			...
			Description: "Transferência enviada pelo Pix Juliana Pereira Alves Ltda",
			AccountID:   accountID,
		},
		{
			Date:        mustParseDate("02/06/2025"),
		...
		},
		{
			...
			Amount:      360.00,
			Type:        models.TransactionTypeExpense,
			Description: "Transferência enviada pelo Pix Susane Aguiar dos Santos",
			AccountID:   accountID,
		},
		{
			...
			Amount:      25.29,
			Type:        models.TransactionTypeExpense,
			Description: "Transferência enviada pelo Pix Ana Carolina Costa Barros Sotovia",
			AccountID:   accountID,
		},
		{
		...
		},
		{
			...
			Amount:      100.00,
			Type:        models.TransactionTypeIncome,
			Description: "Reembolso recebido pelo Pix Silvana Silva da Rosa Prates",
			AccountID:   accountID,
		},
		{
			Date:        mustParseDate("15/06/2025"),
			Amount:      100.00,
			Type:        models.TransactionTypeExpense,
			Description: "Transferência enviada pelo Pix Silvana Silva da Rosa Prates",
			AccountID:   accountID,
		},
		{
			...
			Amount:      100.00,
			Type:        models.TransactionTypeExpense,
			Description: "Transferência enviada pelo Pix Maria Eduarda Hillesheim",
			AccountID:   accountID,
		},
		{
			...
			Amount:      15.00,
			Type:        models.TransactionTypeExpense,
			Description: "Transferência enviada pelo Pix Anna Carolina Prates Furtado",
			AccountID:   accountID,
		},
	}
